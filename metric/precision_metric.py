...
small_classes = {
    ...
    'lu': [101, 102, 104, 106, 108, 121, 123, 124, 125, 141, 142, 143, 144, 145, 146, 147, 164, 162, 163, 164, 165, 166, 201, 202, 302, 303, 304, 403, 422, 423, 424]
}
...
df_data['no_change_predicted'] = ~filter1 & ~filter2
...
df_change = df_data[df_data['has_changed']]
change_weights = dict()
for cindex, row in df_change.iterrows():
